...
| D-pad (누른 채) | 틸트 성분·방향 지정 (↑↓=상하, ←→=좌우) — **D-pad를 누르고 있는 동안에만 ✕/○가 동작** |
| D-pad+✕ 탭 | 지정 방향으로 **현재 값에서** 30° 스텝 (눈금 스냅, 예: 74°→90°) |
| D-pad+✕ 꾹 | 지정 방향으로 연속 미세 틸트 (기본 40°/s, 0.35s 이상 누르면) |
| D-pad+○ 탭 | 해당 성분을 0° 쪽으로 30° 스텝 (예: 74°→60°) |
| D-pad+○ 꾹 | 해당 성분 연속 복귀 (0°에서 정지) |
| ✕ / ○ 단독 | 무시됨 (오조작 방지) |
